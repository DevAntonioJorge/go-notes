...
func (s *FolderService) SaveFolder(ctx context.Context, input dto.CreateFolderRequest) (*models.Folder, error) {
	...
	if err := s.repo.IFolderRepository.SaveFolder(ctx, folder); err != nil {
		return nil, err
	}
	return folder, nil
}
...
func (s *FolderService) GetFolder(ctx context.Context, id string) (*models.Folder, error) {
	return s.repo.IFolderRepository.GetFolder(ctx, id)
}

func (s *FolderService) UpdateFolder(ctx context.Context, input dto.UpdateFolderRequest) (*models.Folder, error) {
	folder, err := s.repo.IFolderRepository.GetFolder(ctx, input.ID)
	if err != nil {
		return nil, err
	}
	newFolder, err := s.repo.IFolderRepository.UpdateFolder(ctx, folder)
	if err != nil {
		return nil, err
	}
...
func (s *FolderService) DeleteFolder(ctx context.Context, id string) error {
	return s.repo.IFolderRepository.DeleteFolder(ctx, id)
}

func (s *FolderService) GetFolders(ctx context.Context, userID string) ([]*models.Folder, error) {
	return s.repo.IFolderRepository.GetFolders(ctx, userID)
}

func (s *FolderService) GetFolderByPath(ctx context.Context, userID, path string) (*models.Folder, error) {
	return s.repo.IFolderRepository.GetFolderByPath(ctx, userID, path)
}

func (s *FolderService) MoveFolder(ctx context.Context, folderID, newParentID string) (*models.Folder, error) {
	folder, err := s.repo.IFolderRepository.GetFolder(ctx, folderID)
	if err != nil {
		return nil, err
	}
	if err := s.repo.IFolderRepository.MoveFolder(ctx, folder, newParentID); err != nil {
		return nil, err
	}
	return folder, nil
}
